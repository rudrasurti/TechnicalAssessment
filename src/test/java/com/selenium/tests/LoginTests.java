...
import static com.appium.constants.FrameworkConstants.EXPECTED_DATA_KEY_WEB_HOME_TITLE;
...
import static com.appium.constants.FrameworkConstants.TEST_DATA_JSON_webValidUser_USER;
...
import com.selenium.pages.WebLoginPage;
...
public class LoginTests extends BaseTestWeb{
	...
	public void successfulLogin() throws InterruptedException {
		...
		JSONObject jsonObject_InvalidUser = new JSONUtils().getJSONObject(TEST_DATA_JSON_FILE).getJSONObject(TEST_DATA_JSON_webValidUser_USER);
		...
		String expectedHomeTitle = StringsManager.getStrings().get(EXPECTED_DATA_KEY_WEB_HOME_TITLE);
